        ...
        <table class="tablepost">
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('posts.edit', $post) }}" class="text-red-600 hover:text-red-900">MODIFIER</a>
                    </td>
                    @csrf
                    @method('DELETE')
                    <td><a href="{{ route('posts.destroy', $post) }}" class="text-red-600 hover:text-red-900">EFFACER</a>
                    </td>
                </tr>
                <tr>
                    <td></td>
